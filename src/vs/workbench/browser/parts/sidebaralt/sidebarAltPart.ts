...
export class SidebarAltPart extends CompositePart<Viewlet> implements IViewletService {

	_serviceBrand: ServiceIdentifier<any>;

	static readonly activeViewletSettingsKey = 'workbench.sidebaralt.activeviewletid';
	...
	layout(width: number, height: number): void {
		if (!this.layoutService.isVisible(Parts.SIDEBAR_ALT_PART)) {
			return;
		}
...
registerSingleton(IViewletService, SidebarAltPart);